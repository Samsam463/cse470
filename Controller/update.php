...
header("location:../View/dash.php?q=3");
}
}
...
header("location:../View/dash.php?q=1");
}
}
//remove quiz
if(isset($_SESSION['key'])){
...
header("location:../View/dash.php?q=5");
}
}
...
header("location:../View/dash.php?q=4&step=2&eid=$id&n=$total");
}
}
...
header("location:../View/dash.php?q=0");
}
}
...
{
$sn++;
header("location:../View/account.php?q=quiz&step=2&eid=$eid&n=$sn&t=$total")or die('Error152');
}
...
header("location:../View/account.php?q=result&eid=$eid");
}
else
{
header("location:../View/account.php?q=result&eid=$eid");
...
$sun=$sun-$s;
$q=mysqli_query($con,"UPDATE `rank` SET `score`=$sun ,time=NOW() WHERE email= '$email'")or die('Error174');
header("location:../View/account.php?q=quiz&step=2&eid=$eid&n=1&t=$t");
}
